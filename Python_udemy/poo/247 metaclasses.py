#  https://www.udemy.com/course/python-3-do-zero-ao-avancado/learn/lecture/15465976#questions
...
Foo = type('Foo', (object,), {}) #mesmo que uma classe. "type" é uma metaclasse
f = Foo()
